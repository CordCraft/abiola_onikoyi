// Shared mindset curriculum for the 91-day mentorship programme.
...
// Compact task tuple: [kind, minutes, title, detail, evidenceHint?]
export function expandTask(tuple, order) {
  const [kind, minutes, title, detail, evidenceHint] = tuple;
  return {
    order,
    kind,
    minutes,
    points: POINTS[kind] ?? 10,
    title,
    detail: detail ?? null,
